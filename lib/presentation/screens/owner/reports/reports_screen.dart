            ...
            children: [
               ...
               Container(
                 ...
                 decoration: BoxDecoration(
                   color: Colors.white,
                   borderRadius: BorderRadius.circular(24),
                   boxShadow: [BoxShadow(color: Colors.grey.withOpacity(0.05), blurRadius: 15, offset: const Offset(0, 4))],
                 ),
                 child: BarChart(
                   BarChartData(
               ...
               const SizedBox(height: 32),
                ...
                // 3.7 Property Performance
                if (data.propertyPerformance.isNotEmpty) ...[
                  Text('Property Performance (All Time)', style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black87)),
                  const SizedBox(height: 16),
                  Container(
                    padding: const EdgeInsets.all(20),
                    decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(20)),
                    child: Column(
                      children: data.propertyPerformance.map((p) {
                        final maxRev = data.propertyPerformance.fold(0.0, (m, e) => e.revenue > m ? e.revenue : m);
                        return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                 Text(p.houseName, style: GoogleFonts.outfit(fontWeight: FontWeight.w600)),
                                 Text('₹${p.revenue.toStringAsFixed(0)}', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: Colors.green)),
                              ],
                            ),
